...
export const INPUT_CLASS =
  'mt-1 block h-8 w-full rounded-md border border-line-strong bg-panel px-2.5 text-sm text-text shadow-xs placeholder:text-text-faint transition-colors hover:border-surface-400 focus-visible:border-accent focus-visible:ring-1 focus-visible:ring-accent focus-visible:outline-none read-only:bg-raised read-only:text-text-muted aria-[invalid=true]:border-danger disabled:cursor-not-allowed disabled:opacity-50';
